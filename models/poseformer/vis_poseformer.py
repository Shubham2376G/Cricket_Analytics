...
def convert_keypoints_to_dict(keypoints, frame_idx):
    """
    Convert keypoints to a dictionary format for a specific frame
    ...
    Returns:
        Dictionary representation of keypoints for this frame
    """
    # Define joint names (you can modify these to match your skeleton)
    joint_names = [
        "Pelvis", "Right Hip", "Right Knee", "Right Ankle", "Left Hip",
        "Left Knee", "Left Ankle", "Spine", "Thorax", "Neck/Nose",
    ...
    # Add each joint's coordinates to the dictionary
    for i in range(keypoints.shape[0]):
        joint = {
            ...
            "z": float(keypoints[i, 2])
        }
        frame_data["joints"].append(joint)
...
def get_pose3D(video_path,keypoints_path, output_dir):
    ...
    with open(f"{output_dir}/all_poses_3d.json", 'w') as f:
        json.dump(final_data, f, indent=4)

    print(f"All keypoints saved to all_poses_3d.json")
