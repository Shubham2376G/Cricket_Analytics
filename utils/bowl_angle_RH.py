...
# Example Mohit Usage
video_path = "Enter the path to the video file: "
json_path = "Enter the path to the keypoints JSON file: "
output_path = "Enter the path to save the output video: "
output_json_path = "Enter the path to save the output keypoints JSON: "
court_polygon = [(476, 174), (797, 174), (797, 455), (476, 455)]  # Mohit
output_folder = "Enter the path to save bowler detection outputs: "
